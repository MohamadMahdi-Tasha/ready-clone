            ...
            <main>
                <HolderComponent className={'px-[20px]'}>
                    <div className={'mb-[100px]'}>
                        <h1 className={`sm:text-center lg:text-[50px] text-[40px] text-gray-800 font-bold lg:leading-[60px] leading-[40px] mb-[30px] ${walsheimFont.className}`}><span className={'bg-line-fifth-section-1'}>All</span> in a calendar, <br/> that’s a <span className={'bg-line-fifth-section-2'}>joy to use</span></h1>
                        <p className={'sm:text-center text-gray-800 text-[18px] font-normal mb-[50px]'}>An entire meeting collaboration platform built inside a fast <br/> and modern calendar you and your team will love.</p>
