        ...
        <section className={'lg:mt-[150px] mt-[50px]  overflow-hidden'}>
            <main>
                <HolderComponent className={'p-[20px]'}>
                    ...
                    <div className={'flex gap-[20px] -translate-x-[50%]'}>
                        <img className={'lg:w-[30vw] w-[20rem]'} src={demoImage1.src} alt="Demo image of the ready app"/>
                        <img className={'lg:w-[30vw] w-[20rem]'} src={demoImage2.src} alt="Demo image of the ready app"/>
                        <img className={'lg:w-[30vw] w-[20rem]'} src={demoImage3.src} alt="Demo image of the ready app"/>
                        <img className={'lg:w-[30vw] w-[20rem]'} src={demoImage1.src} alt="Demo image of the ready app"/>
                        <img className={'lg:w-[30vw] w-[20rem]'} src={demoImage2.src} alt="Demo image of the ready app"/>
                        <img className={'lg:w-[30vw] w-[20rem]'} src={demoImage3.src} alt="Demo image of the ready app"/>
                        <img className={'lg:w-[30vw] w-[20rem]'} src={demoImage1.src} alt="Demo image of the ready app"/>
